...
HD_PWD='C:/Users/ikeno/Documents/VIVADO/OV7675_test/OV7675_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov7675_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov7675_test_wrapper.tcl -notrace
